...
if golongan == 'R1':
    ...
    if daya > 200000:
        print(f'jumlah tagihan anda: {Pemakaian * 1114.74:,}'.replace('.',',').replace('_','.'))
    else:
        print('data tidak valid')
elif golongan == 'I3':
    if daya >= 200000:
        print(f'jumlah tagihan anda: {Pemakaian * 1314.12:,}'.replace('.',',').replace('_','.'))
    else:
        print('data tidak valid')
elif golongan == 'P1':
    if daya >=6600 and daya <= 200000:
        print(f'jumlah tagihan anda: {Pemakaian * 1523.28:,}'.replace('.',',').replace('_','.'))
    else:
        print('data tidak valid')
else:
